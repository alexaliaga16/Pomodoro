    ...
    <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
      {Object.entries(MODOS_LABELS).map(([key, label]) => (
        <GlassButton
          ...
          className={`timer-top-button min-w-[122px] px-4 py-2 rounded-full text-center text-[20px] sm:text-[20px] leading-none tracking-[0.08em] transition-all hover:scale-105 sm:min-w-[128px] sm:px-5
