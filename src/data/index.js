...
export const extraVibes = [
  { name: "Lofi Beats", url: "https://stream.zeno.fm/f3wvbbqmdg8uv", color: "#14b8a6", image: "/vibes/lofi-beats.jpg" },
  { name: "Chill House", url: "https://stream.zeno.fm/8es08f3rkrhvv", color: "#06b6d4", image: "/vibes/chill-house.jpg" },
  { name: "Jazz Cafe", url: "https://stream.zeno.fm/0r0xa792kwzuv", color: "#fb7185", image: "/vibes/jazz-cafe.jpg" },
  { name: "Synthwave", url: "https://stream.zeno.fm/2b2h6y6sxy8uv", color: "#f43f5e", image: "/vibes/synthwave.jpg" },
];

export const defaultBg = "/fondo.png";
